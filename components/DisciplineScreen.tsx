        ...
        <div style={{ display: "grid", gap: "12px" }}>
          ...
          {fineTab === "awarded" && (
            <>
              ...
              <div style={styles.card}>
                <h2 style={styles.screenTitle}>Souhrn pokut</h2>
                ...
                {!activePeriod ? (
                  ...
                  <div style={{ display: "grid", gap: "10px" }}>
                    ...
                    >
                      ...
                      <div>
                        Celkem: <strong>{totalFineAmount} Kč</strong>
                      </div>
                      <div>
                        Zaplaceno: <strong>{paidFineAmount} Kč</strong>
                      </div>
                      <div>
                        Nezaplaceno: <strong>{unpaidFineAmount} Kč</strong>
                      </div>
                    </div>
                      ...
                      <div style={{ display: "grid", gap: "10px" }}>
                        {fineSummary.map((item) => (
                          ...
                          >
                            ...
                            <div style={{ fontSize: "13px", color: "#b8b8b8", marginTop: "6px" }}>
                              Pokut: {item.fines_count}
                            </div>
                            <div style={{ fontSize: "13px", color: "#b8b8b8", marginTop: "4px" }}>
                              Celkem: {item.total_amount} Kč
                            </div>
                            <div style={{ fontSize: "13px", color: "#8fe1a7", marginTop: "4px" }}>
                              Zaplaceno: {item.paid_amount} Kč
                            </div>
                            <div style={{ fontSize: "13px", color: "#ffb0a8", marginTop: "4px" }}>
                              Nezaplaceno: {item.unpaid_amount} Kč
                            </div>
                          </div>
                        ))}
                      </div>
              ...
              <div style={styles.card}>
                <h2 style={styles.screenTitle}>Seznam pokut</h2>
                        ...
                        >
                          ...
                          >
                            <div style={{ flex: 1 }}>
                              ...
                              <div style={{ marginTop: "6px", fontSize: "13px", color: "#b8b8b8" }}>
                                {fine.fine_date} • {fine.amount} Kč
                              </div>
                              {fine.note && (
                                <div
                                  style={{
                          ...
                          <div style={{ display: "flex", gap: "8px", marginTop: "12px" }}>
                            ...
                            >
                              {fine.is_paid ? "Vrátit na nezaplaceno" : "Označit jako zaplacené"}
                            </button>
